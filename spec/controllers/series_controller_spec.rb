  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved series as @series" do
        ...
        post :create, {:series => { "title" => "invalid value" }}, valid_session
        assigns(:series).should be_a_new(Series)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested series" do
        ...
        Series.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => series.to_param, :series => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the series as @series" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Series.any_instance.stub(:save).and_return(false)
        put :update, {:id => series.to_param, :series => { "title" => "invalid value" }}, valid_session
        assigns(:series).should eq(series)
      end
