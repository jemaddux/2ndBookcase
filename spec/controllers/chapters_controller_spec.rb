  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved chapter as @chapter" do
        ...
        post :create, {:chapter => { "book_id" => "invalid value" }}, valid_session
        assigns(:chapter).should be_a_new(Chapter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested chapter" do
        ...
        Chapter.any_instance.should_receive(:update).with({ "book_id" => "1" })
        put :update, {:id => chapter.to_param, :chapter => { "book_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the chapter as @chapter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Chapter.any_instance.stub(:save).and_return(false)
        put :update, {:id => chapter.to_param, :chapter => { "book_id" => "invalid value" }}, valid_session
        assigns(:chapter).should eq(chapter)
      end
